...
hrs_data <- hrs_data |>
  ...
  dplyr::mutate(Organised_w4 = personality_max + 1 - Organised_w4) |>
  dplyr::mutate(Hardworking_w4 = personality_max + 1 - Hardworking_w4) |>
  dplyr::mutate(Self_disiplined_w4 = personality_max + 1 - Self_disiplined_w4) |>
  dplyr::mutate(Cautious_w4 = personality_max + 1 - Cautious_w4) |>
  dplyr::mutate(Thorough_w4 = personality_max + 1 - Thorough_w4) |>
  dplyr::mutate(Thrifty_w4 = personality_max + 1 - Thrifty_w4) |>
  dplyr::mutate(Moody_w4 = personality_max + 1 - Moody_w4) |>
  dplyr::mutate(Worrying_w4 = personality_max + 1 - Worrying_w4) |>
  dplyr::mutate(Nervous_w4 = personality_max + 1 - Nervous_w4)
